...
#ifndef __exlcm_quad_state_t_hpp__
#define __exlcm_quad_state_t_hpp__
...
int quad_state_t::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int quad_state_t::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int quad_state_t::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t quad_state_t::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* quad_state_t::getTypeName()
{
    return "quad_state_t";
}

int quad_state_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int quad_state_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int quad_state_t::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
